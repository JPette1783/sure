class Import < ApplicationRecord
  ...
  TYPES = %w[TransactionImport TradeImport AccountImport MintImport YnabImport ActualImport CategoryImport RuleImport PdfImport QifImport SureImport].freeze
